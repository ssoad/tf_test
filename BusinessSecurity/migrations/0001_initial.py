# Generated by Django 3.2.7 on 2021-10-23 10:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_customer', models.IntegerField(blank=True, default=0, verbose_name='Total Customer')),
                ('fields', models.ManyToManyField(related_name='subservice_inputfields', to='BusinessSecurity.InputFields')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subservice_service', to='BusinessSecurity.service')),
            ],
            options={
