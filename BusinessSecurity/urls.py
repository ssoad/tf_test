...
urlpatterns = [
    ...
    path('bcs_user_my_team_user/', views.bcsUserMyTeamProfileView, name='bcs_user_my_team_user'),
    path('bcs_user_my_team_user/<id>/', views.bcsUserMyTeamProfileView, name='bcs_user_my_team_user'),
    ...
    path('bcs_admin_subscription_services_delete/<id>/', views.bcsAdminSubscriptionServiceDeleteView, name='bcs_admin_subscription_services_delete'),
    path('bcs_admin_services_delete/<id>/', views.bcsAdminServiceDeleteView, name='bcs_admin_services_delete'),
    path('bcs_admin_subscription_services_edit/<id>/', views.bcsAdminSubscriptionServiceEditView, name='bcs_admin_subscription_services_edit'),
    ...
    path('bcs_admin_subscription_packages_feature_delete/<id>/', views.bcsAdminSubscriptionPackFeatureDelete,
         name='bcs_admin_subscription_packages_feature_delete'),
    path('bcs_admin_individual_business/', views.bcsAdminIndividualBusiness, name='bcs_admin_individual_business'),
    ...
    path('bcs_admin_profile/<id>/', views.bcsAdminProfile, name='bcs_admin_profile'),
