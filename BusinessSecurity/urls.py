...
urlpatterns = [
    ...
    path('main_admin_notification_delete/', views.mainAdminNotificationDeleteView, name='main_admin_notification_delete'),
    path('main_admin_notification_delete/<id>/', views.mainAdminNotificationDeleteView, name='main_admin_notification_delete'),
