...
urlpatterns = [
    ...
    path('bcs/main_admin_lastmonth_chart/', views.BCSAdminDashboardLastMonthChartApiView.as_view(),
    ...
    path('pcs/main_admin_lastmonth_chart/', views.PCSAdminDashboardLastMonthChartApiView.as_view(),
         name='main_admin_lastmonth_chart'),
